...
//!
//! Parses guyumate:// URLs into DeepLinkImportRequest structures.
...
/// Parse a guyumate:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// guyumate://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "guyumate" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'guyumate', got '{scheme}'"
        )));
    }

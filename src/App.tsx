...
const VIEW_STORAGE_KEY = "guyu-mate-last-view";
...
function App() {
  ...
  const [activeApp, setActiveApp] = useState<AppId>("claude" as AppId);
            ...
            <div className="px-6 flex flex-col h-[calc(100vh-8rem)] overflow-hidden">
              <div className="flex-1 overflow-y-auto overflow-x-hidden pb-12 px-1">
                <AnimatePresence mode="wait">
                  ...
                  >
                    {/* 引导提示区域 */}
                    <div className="rounded-lg border border-border bg-card/50 p-4 mb-2">
                      <h2 className="text-base font-semibold mb-2">AI 供应商管理</h2>
                      <p className="text-sm text-muted-foreground mb-3">
                        在这里管理你的 Claude Code API 供应商配置。点击供应商卡片可以切换当前使用的供应商。
                      </p>
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ paddingTop: DRAG_BAR_HEIGHT }}
      >
        <Sidebar
